...
void render(void) {
	...
	glUniformMatrix4fv(0, 1, GL_FALSE, 
		perspective(45.0f, winSize.w / winSize.h, 0.1f, 100.0f) * 
		lookat(vec3(0.0f, 0.0f, 5.0f), vec3(0.0f, 0.0f, 0.0f), vec3(0.0f, 1.0f, 0.0f)) *
		translate(-1.0f, -1.0f, 0.0f) * rotate(degrees((float)getTime()), 0.0f, 0.0f, 1.0f));
	glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, NULL);
	glUniformMatrix4fv(0, 1, GL_FALSE, 
		perspective(45.0f, winSize.w / winSize.h, 0.1f, 100.0f) * 
		lookat(vec3(0.0f, 0.0f, 5.0f), vec3(0.0f, 0.0f, 0.0f), vec3(0.0f, 1.0f, 0.0f)) *
		translate(1.0f, 1.0f, 0.0f) * scale(sin((float)getTime()) * 0.5f + 0.5f));
	glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, NULL);
}
