...
void createProgram() {
	...
	cout<<glshaderCreate(&vertexDiffuseShader, GL_VERTEX_SHADER, "shaders/gorad.vert");
	cout<<glshaderCreate(&fragmentDiffuseShader, GL_FRAGMENT_SHADER, "shaders/gorad.frag");

	cout<<glprogramCreate(&diffuseProgram, "Gorad", vector<glshader_dl>({vertexDiffuseShader, fragmentDiffuseShader}));
}
