...
void render(void) {
	...
	vec3 lightColor;
	lightColor[0] = sin(getTime() * 2.0f);
	lightColor[1] = sin(getTime() * 0.7f);
	lightColor[2] = sin(getTime() * 1.3f);
	...
	glUniform3fv(5, 1, lightAmbient);
	glUniform3fv(6, 1, lightDiffuse);
	glUniform3f(7, 1.0f, 1.0f, 1.0f);
	glUniform3f(8, 1.0f, 0.5f, 0.31f);
	glUniform3f(9, 1.0f, 0.5f, 0.31f);
	glUniform3f(10, 0.5f, 0.5f, 0.5f);
