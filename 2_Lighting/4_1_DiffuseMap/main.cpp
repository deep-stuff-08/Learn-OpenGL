...
void createProgram() {
	...
	cout<<glshaderCreate(&vertexDiffuseShader, GL_VERTEX_SHADER, "shaders/diffuse.vert");
	cout<<glshaderCreate(&fragmentDiffuseShader, GL_FRAGMENT_SHADER, "shaders/diffuse.frag");

	cout<<glprogramCreate(&diffuseProgram, "Diffuse", vector<glshader_dl>({vertexDiffuseShader, fragmentDiffuseShader}));
}
