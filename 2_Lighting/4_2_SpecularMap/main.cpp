...
void createProgram() {
	...
	cout<<glshaderCreate(&vertexDiffuseShader, GL_VERTEX_SHADER, "shaders/specular.vert");
	cout<<glshaderCreate(&fragmentDiffuseShader, GL_FRAGMENT_SHADER, "shaders/specular.frag");

	cout<<glprogramCreate(&diffuseProgram, "Specular", vector<glshader_dl>({vertexDiffuseShader, fragmentDiffuseShader}));
}
