...
void render() {
	...
	glUniform3fv(5, 1, glcamera.front);
	glUniform2f(6, 12.5f, 17.5f);
	glUniform3f(7, 0.1f, 0.1f, 0.1f);
	glUniform3f(8, 0.7f, 0.7f, 0.7f);
	glUniform3f(9, 1.0f, 1.0f, 1.0f);
	glUniform3f(10, 1.0f, 0.04f, 0.012f);
