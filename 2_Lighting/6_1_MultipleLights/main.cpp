...
void render() {
	...
	lights->dir.ambient = vec3(0.05f, 0.05f, 0.05f);
	lights->dir.diffuse = vec3(0.4f, 0.4f, 0.4f);
	lights->dir.specular = vec3(0.5f, 0.5f, 0.5f);
	// point light 1
	lights->point[0].position = pointLightPositions[0];
	lights->point[0].ambient = vec3(0.05f, 0.05f, 0.05f);
	lights->point[0].diffuse = vec3(0.8f, 0.8f, 0.8f);
	lights->point[0].specular = vec3(1.0f, 1.0f, 1.0f);
	...
	lights->point[1].ambient = vec3(0.05f, 0.05f, 0.05f);
	lights->point[1].diffuse = vec3(0.8f, 0.8f, 0.8f);
	lights->point[1].specular = vec3(1.0f, 1.0f, 1.0f);
	...
	lights->point[2].ambient = vec3(0.05f, 0.05f, 0.05f);
	lights->point[2].diffuse = vec3(0.8f, 0.8f, 0.8f);
	lights->point[2].specular = vec3(1.0f, 1.0f, 1.0f);
	...
	lights->point[3].ambient = vec3(0.05f, 0.05f, 0.05f);
	lights->point[3].diffuse = vec3(0.8f, 0.8f, 0.8f);
	lights->point[3].specular = vec3(1.0f, 1.0f, 1.0f);
