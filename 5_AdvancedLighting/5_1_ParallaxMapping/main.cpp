...
enum texlist {
	texBrickwallDiffuse,
	texBrickwallNormal,
	texBrickwallDisplacement,
	texToyBoxDiffuse,
	texToyBoxNormal,
	texToyBoxDisplacement,
	texLen
};
...
void init(void) {
	...
	cout<<createTexture2D(&glo.tex[texBrickwallDiffuse], "../../resources/bricks2.jpg");
	cout<<createTexture2D(&glo.tex[texBrickwallNormal], "../../resources/bricks2_normal.jpg");
	cout<<createTexture2D(&glo.tex[texBrickwallDisplacement], "../../resources/bricks2_disp.jpg");
	cout<<createTexture2D(&glo.tex[texToyBoxDiffuse], "../../resources/toy_box_diffuse.png");
	cout<<createTexture2D(&glo.tex[texToyBoxNormal], "../../resources/toy_box_normal.png");
	cout<<createTexture2D(&glo.tex[texToyBoxDisplacement], "../../resources/toy_box_disp.png");
}
...
void render(void) {
	...
	if(isBricks) {
		...
		glBindTexture(GL_TEXTURE_2D, glo.tex[texBrickwallDisplacement]);
	} else {
		glActiveTexture(GL_TEXTURE0);
		glBindTexture(GL_TEXTURE_2D, glo.tex[texToyBoxDiffuse]);
		glActiveTexture(GL_TEXTURE1);
		glBindTexture(GL_TEXTURE_2D, glo.tex[texToyBoxNormal]);
		glActiveTexture(GL_TEXTURE2);
		glBindTexture(GL_TEXTURE_2D, glo.tex[texToyBoxDisplacement]);
	}
